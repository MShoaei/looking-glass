...
func TestPlugin_Run(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "empty enabled", fields: fields{enabled: true}, args: args{params: nil}, wantStdout: "", wantStderr: "Usage:", wantErr: false},
		{name: "empty disabled", fields: fields{enabled: false}, args: args{params: nil}, wantStdout: "", wantStderr: "", wantErr: true},
		{name: "Hello", fields: fields{enabled: true}, args: args{params: []string{"--version"}}, wantStdout: "", wantStderr: "traceroute", wantErr: false},
		{name: "transmit", fields: fields{enabled: true}, args: args{params: []string{"google.com"}}, wantStdout: "traceroute to google.com", wantStderr: "", wantErr: false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			p := &Plugin{
